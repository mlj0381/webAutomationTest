...
#公开课
class TestFineClass(unittest.TestCase):
...
#----------------------------------------------------------------------------------------------------------------------#
    ...
    def test_fine_class_success(self):
        ...
        if db_user == 0:
            ...
            # 预约精品小班课
            user_fine_class_success(driver, current_window_handle, login_after_url_link,wealth_data,str(user_user_id_value),str(user_mobile_value))
